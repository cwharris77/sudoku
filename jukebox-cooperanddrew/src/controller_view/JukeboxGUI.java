...
public class JukeboxGUI extends Application {
	...
	/**
	 * this will handle the action event for when the user wants to add a song to the
	 * queue
	 */
		...
		add1.setOnAction(event -> {
			...
			if (loginPane.getLoggedIn() == true) {
				...
				// alerts user that they have use all their songs
					...
					alert.setHeaderText("You Have Played All Your Songs For Today Log Out And Come Back Tomorrow");
